...
for j in range(len(mat_file_list)):
    ...
    np.savetxt(os.path.join("scores_mat", mat_file+'1.csv'), score_mat, delimiter=',')
    np.savetxt(os.path.join("scores_mat", mat_file+'.em.csv'), em_mat, delimiter=',')
    np.savetxt(os.path.join("scores_mat", mat_file+'.mv.csv'), mv_mat, delimiter=',')
    ...
    time_df.to_csv('time_mat_2.csv', index=False, float_format='%.3f')
    time2_df.to_csv('time2_mat_2.csv', index=False, float_format='%.3f')
    roc_df.to_csv('roc_mat_2.csv', index=False, float_format='%.3f')
    prn_df.to_csv('prns_mat_2.csv', index=False, float_format='%.3f')
    ap_df.to_csv('ap_mat_2.csv', index=False, float_format='%.3f')
