...
'WPBC']:
    dataset = c
    dataset_dir = "OD_Intrinsic_Measure/scores_arff/{}".format(dataset)
    score = pd.read_csv('{}.csv'.format(dataset_dir), header=None)
    ap_csv = pd.read_csv('OD_Intrinsic_Measure/ap_arff.csv')
    ...
    # rank of roc
    roc_csv = pd.read_csv('OD_Intrinsic_Measure/roc_arff.csv')
    ...
    # rank of prn
    prn_csv = pd.read_csv('OD_Intrinsic_Measure/prns_arff.csv')
